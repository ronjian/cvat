...
modify /var/lib/postgresql/data/pg_hba.conf
...
############# launch dev ############
nohup redis-server > rockrobo/redis.log 2>&1 &
nohup python manage.py rqworker default --worker-class cvat.simpleworker.SimpleWorker > rockrobo/rqworker_default.log 2>&1 &
nohup python manage.py rqworker low --worker-class cvat.simpleworker.SimpleWorker > rockrobo/rqworker_low.log 2>&1 &
nohup python manage.py rqscheduler > rockrobo/rqscheduler.log 2>&1 &
nohup python manage.py runserver --insecure 0.0.0.0:7000 > rockrobo/runserver.log 2>&1 &
cd cvat-ui; nohup npm start > ../rockrobo/cvat-ui.log 2>&1 &
